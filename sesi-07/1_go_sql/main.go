...
func CreateEmployee() {
	...
	err = db.QueryRow(sqlStatement, "Aurora", "aurora@gmail.com", 16, "Sleeper").Scan(&employee.ID, &employee.Full_name, &employee.Email, &employee.Age, &employee.Division)
...
func UpdateEmployee() {
	...
	res, err := db.Exec(sqlStatement, 1, "Merida", "merida@gmail.com", "Warior", 17)
